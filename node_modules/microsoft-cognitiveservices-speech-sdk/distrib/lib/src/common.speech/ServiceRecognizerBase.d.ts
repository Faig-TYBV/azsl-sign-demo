...
export declare abstract class ServiceRecognizerBase implements IDisposable {
    ...
    private privEnableReliableReconnect;
    private privContinuationState;
    ...
    connectAsync(cb?: (result?: any) => void, err?: (result?: any) => void): void;
    ...
    private get audioStreamId();
    private applyReconnectContinuation;
